...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Mon Jan 18 00:43:51 2010
# Project:  qtweet.pro
# Template: subdirs
# Command: /usr/bin/qmake -unix -o Makefile qtweet.pro
#############################################################################
...
QTweetCore/$(MAKEFILE): 
	...
	cd QTweetCore/ && $(QMAKE) QTweetCore.pro -unix -o $(MAKEFILE)
...
QTweetGui/$(MAKEFILE): 
	...
	cd QTweetGui/ && $(QMAKE) QTweetGui.pro -unix -o $(MAKEFILE)
...
QTweetDeck/$(MAKEFILE): 
	...
	cd QTweetDeck/ && $(QMAKE) QTweetDeck.pro -unix -o $(MAKEFILE)
...
Makefile: qtweet.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -unix -o Makefile qtweet.pro
